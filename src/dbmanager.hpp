...
public:
	 ...
	 * \return vector< map<string, string> > The record list obtained from the SQL table. A record is a pair "field name"-"field value".
	 */
	std::vector< std::map<std::string, std::string> > getPartialTableWithoutDuplicates(const std::string& table, const std::vector<std::basic_string<char> >& columns);
	/**
	 * \brief DBus table content getter
	 *
	 ...
	 * \return vector< map<string, string> > The record list obtained from the SQL table. A record is a pair "field name"-"field value".
	 */
	std::vector< std::map<std::string, std::string> > getPartialTable(const std::string& table, const std::vector<std::basic_string<char> >& columns);
	/**
	 * \brief DBus table content getter
	 *
	 ...
	 * \return vector< map<string, string> > The record list obtained from the SQL table. A record is a pair "field name"-"field value".
	 */
	std::vector< std::map<std::string, std::string> > getFullTableWithoutDuplicates(const std::string& table);
	/**
	 * \brief DBus table content getter
	 *
	 ...
	 * \return vector< map<string, string> > The record list obtained from the SQL table. A record is a pair "field name"-"field value".
	 */
	std::vector< std::map<std::string, std::string> > getFullTable(const std::string& table);
	 ...
	 * \return bool The success or failure of the operation.
	 */
	bool modifyRecord(const std::string& table, const std::map<std::string, std::string>& refFields, const std::map<std::basic_string<char>, std::basic_string<char> >& values);
	/**
	 * \brief table record setter
	 *
	 * Allows to update a record of a table. Can be called over DBus.
...
private :
	 ...
	 */
	DBManager(DBus::Connection &connection, std::string filename = PATH_DB);
	/**
	 * \brief Destructor.
	 *
	 */
